...
const AuthGate = () => {
  ...
  return (
    // h-screen + flex column so the centered card is *exactly* in the
    // middle of the viewport (not just the document) and the footer can
    // hug the bottom without absolute positioning side-effects.
    <section className="relative h-screen w-screen flex flex-col overflow-hidden bs-bg-grid">
      <AmbientPcb />

      <div className="relative z-10 flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-sm flex flex-col items-center text-center">
          {/* Logo + wordmark — stacked & centered as a single block */}
          <div className="flex flex-col items-center gap-3 mb-8">
            <BoardsmithLogo size={56} />
            <div className="flex flex-col items-center">
              ...
              <span
                className="font-mono text-[10px] mt-2 uppercase tracking-[0.22em]"
          ...
          <div
            className="mb-7 inline-flex items-center gap-2 px-3 py-1 rounded-full font-mono text-[11px]"
            style={{
          ...
          <h1
            className="mb-3 text-[32px] leading-[1.1] font-semibold tracking-tight"
            style={{ color: "var(--bs-fg)" }}
          >
          ...
          <p
            className="mb-8 text-[13.5px] leading-relaxed"
          ...
          <button
            ...
            disabled={loading}
            className="bs-btn-primary w-full px-5 py-3 rounded flex items-center justify-center gap-3 text-[14px] font-medium disabled:opacity-50"
          >
            <GoogleGlyph />
      ...
      <footer
        className="relative z-10 flex justify-between px-6 py-4 font-mono text-[10px] uppercase tracking-widest shrink-0"
        style={{ color: "var(--bs-fg-dim)" }}
      >
